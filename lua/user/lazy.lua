...
require('lazy').setup({
  spec = {
    ...
    { 'hiphish/rainbow-delimiters.nvim', dependencies = {'nvim-treesitter/nvim-treesitter'}, config = function() require('plugins.rainbow-delimiters') end },
    ...
    { 'nvim-treesitter/nvim-treesitter-context', dependencies = {'nvim-treesitter/nvim-treesitter'}, config = function() require('plugins.nvim-treesitter-context') end },
    ...
    { "OXY2DEV/helpview.nvim", dependencies = { "nvim-treesitter/nvim-treesitter" } },
    { 'mcauley-penney/visual-whitespace.nvim', config = true },
    { "folke/snacks.nvim", opts = {image = {}, bigfile = {}} },

    -- reading mode
    { 'folke/zen-mode.nvim', dependencies = {'folke/twilight.nvim'}, config = function() require('plugins.zen-mode') end },

    -- functional
    { 'nvim-telescope/telescope.nvim', tag = '0.1.7', dependencies = {{'nvim-lua/plenary.nvim'}}, config = function() require('plugins.nvim-telescope') end },
    ...
    { "rcarriga/nvim-dap-ui", dependencies = {"mfussenegger/nvim-dap", "nvim-neotest/nvim-nio"}, config = function() require'plugins.nvim-dap-ui' end },
    ...
    { 'mfussenegger/nvim-dap-python', dependencies = {"mfussenegger/nvim-dap"}, config = function() require("dap-python").setup("/Users/ch/.local/share/nvim/mason/packages/debugpy/venv/bin/python3.13") end },
    { 'leoluz/nvim-dap-go', dependencies = {"mfussenegger/nvim-dap"}, config = function() require("dap-go").setup() end },
    ...
    { "AckslD/nvim-neoclip.lua", dependencies = {{'nvim-telescope/telescope.nvim'}}, config = function() require'plugins.nvim-neoclip' end },
    { "junegunn/vim-peekaboo" },
    { "nvim-neotest/neotest", dependencies = { "nvim-neotest/nvim-nio", "nvim-lua/plenary.nvim", "antoinemadec/FixCursorHold.nvim", "nvim-treesitter/nvim-treesitter" } , config = function() require'plugins.neotest' end},
    ...
    {'kevinhwang91/nvim-ufo', dependencies = 'kevinhwang91/promise-async', config = function() end },
    ...
    { "rmagatti/goto-preview", event = "BufEnter", config = function() require('goto-preview').setup{ default_mappings = true } end },
    { "t-troebst/perfanno.nvim", config = function() require('perfanno').setup() end },
    { "meznaric/key-analyzer.nvim", opts = {} },
    { "Goose97/timber.nvim", event = "VeryLazy", config = function() require("timber").setup({}) end },
    { 'kevinhwang91/nvim-fundo', requires = 'kevinhwang91/promise-async', run = function() require('fundo').install() end },
    ...
    -- autocompletor
    { 'saghen/blink.cmp', version = '1.*', dependencies = { 'rafamadriz/friendly-snippets', "saghen/blink.compat" }, config = function() require('plugins.blink-cmp') end },
    { 'saghen/blink.compat', version = '*', opts = { impersonate_nvim_cmp = true, debug = true } },
    ...
    { "nvimtools/none-ls.nvim", dependencies = { "nvim-lua/plenary.nvim" }, config = function() require'plugins.none-ls' end },
    ...
    { "askfiy/visual_studio_code" },
      { 'sainnhe/sonokai', lazy = false, priority = 1000, config = function() vim.g.sonokai_enable_italic = true end },
  },
  defaults = { lazy == true },
})
